# XAUUSD 黃金分析技術文件
# 版本：20260705 | 策略：黃金劍盾（S1 V3.7 / S2 V1.9 / S1-Fail）+ SMC 輔助參考
...
- 「策略 Alerts 紀錄」：**上限約 1 週（7-10 筆）**，超過的搬到 context_archive.md
  再從 context.md 刪除（20260705 前這條規則沒被落實，累積到 50+ 筆，已一次性清理）。
