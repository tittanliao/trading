...
### S1 — 右側趨勢（The Sword, V3.4）
- **風格**：吃魚身，捕捉 H4/Daily 級別單邊行情
- **核心**：順勢突破進場
- **進場條件**：
  ...
  4. Close > 1H MA(3) 濾網
- **止損**：進場價 × (1 - 0.5%)
- **止盈**：TP1 = 進場價 × (1 + 0.5%)，TP2 = 進場價 × (1 + 1.75%)
- **適用環境**：4H/Daily 趨勢明確、BB 帶擴張、AO 正值上升

### S2 — 左側反轉（The Shield, V1.9）
- **風格**：高盈虧比，應對震盪盤或假突破
- **核心**：逆勢接刀 / 回調買入
- **進場條件**：
  1. 標準錘頭線（下影線 > 2倍實體）
  ...
  3. 需在關鍵支撐位執行（人工過濾）
- **止損**：進場價 × (1 - 1.0%)
- **止盈**：TP1 = 進場價 × (1 + 2.0%)，TP2 = 進場價 × (1 + 4.0%)
